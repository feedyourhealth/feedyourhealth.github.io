// js/tabs/messages.js
// The '💬 Μηνύματα' tab — one chronological list of everything clients send from
// their portal link (client_logs notes + low weekly plan_feedback), the last of
// app-part5-home.js (module split wave 42 — that file is now removed):
//   MSG_PF_HISTORY_WEEKS, collectAllClientMessages, msgDaysAgoText, msgMarkSeen,
//   msgRowHtml, groupMessagesByClient, msgGroupCardHtml, msgMarkAllSeen, msgRefresh,
//   _msgFilter/_msgGroupBy/_msgSearch, msgSetSearch, msgResultsHtml, renderMessages,
//   updateMessagesNavBadge.
// Reuses replyToClientNote/replyToPlanFeedback (portal-comms/portal-comms.js) so
// 'replied' is one source of truth. Pure fn declarations + literal state vars, zero
// load-time code. renderMessages/updateMessagesNavBadge are typeof-guarded runtime
// calls from swTab / roster-ui.js. Loads in the tabs/ group.
