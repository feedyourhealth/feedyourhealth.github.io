...
var SUPPS=[
 {id:'iron',   name:'Σίδηρος',            nameEn:'Iron',              nameRu:'Железо',                    nameTr:'Demir',                     dose:'',              cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Πριν το πρωινό",d:''}]},
 {id:'multivit',name:'Πολυβιταμίνη',      nameEn:'Multivitamin',      nameRu:'Поливитамины',              nameTr:'Multivitamin',              dose:'',              cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:''},{t:"Μεσημεριανό",d:''}]},
 {id:'bcomplex',name:'Β-Complex',          nameEn:'B-Complex',         nameRu:'Витамины группы B',         nameTr:'B Kompleks',                dose:'',              cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Μεσημεριανό",d:''}]},
 {id:'vit_e',  name:'Βιταμίνη Ε',         nameEn:'Vitamin E',         nameRu:'Витамин E',                 nameTr:'E Vitamini',                dose:'',              cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Βραδινό",d:''}]},
 {id:'vit_d3', name:'Βιταμίνη D3',        nameEn:'Vitamin D3',        nameRu:'Витамин D3',                nameTr:'D3 Vitamini',               dose:'1000-4000 IU',  doseRu:'1000-4000 МЕ',  doseTr:'1000-4000 IU',  cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:'1000-2000 IU',dRu:'1000-2000 МЕ',dTr:'1000-2000 IU'},{t:"Βραδινό",d:'1000-2000 IU',dRu:'1000-2000 МЕ',dTr:'1000-2000 IU'}]},
 {id:'magn',   name:'Μαγνήσιο',           nameEn:'Magnesium',         nameRu:'Магний',                    nameTr:'Magnezyum',                 dose:'',              cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Βραδινό",d:''}]},
 {id:'vit_c',  name:'Βιταμίνη C',         nameEn:'Vitamin C',         nameRu:'Витамин C',                 nameTr:'C Vitamini',                dose:'500-1000mg',    doseRu:'500-1000мг',    doseTr:'500-1000mg',    cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:'500mg',dRu:'500мг',dTr:'500mg'},{t:"Μεσημεριανό",d:'500mg',dRu:'500мг',dTr:'500mg'}]},
 {id:'calc',   name:'Ασβέστιο',           nameEn:'Calcium',           nameRu:'Кальций',                   nameTr:'Kalsiyum',                  dose:'1000-1200mg',   doseRu:'1000-1200мг',   doseTr:'1000-1200mg',   cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:'500mg',dRu:'500мг',dTr:'500mg'},{t:"Βραδινό",d:'500mg',dRu:'500мг',dTr:'500mg'}]},
 {id:'zinc',   name:'Ψευδάργυρος (Zinc)', nameEn:'Zinc',              nameRu:'Цинк',                      nameTr:'Çinko',                     dose:'15-25mg',       doseRu:'15-25мг',       doseTr:'15-25mg',       cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Βραδινό",d:'15-25mg',dRu:'15-25мг',dTr:'15-25mg'}]},
 {id:'omega3', name:'Omega-3 / Fish Oil',  nameRu:'Омега-3 / Рыбий жир',       nameTr:'Omega-3 / Balık Yağı',      dose:'1000-3000mg',   doseRu:'1000-3000мг',   doseTr:'1000-3000mg',   cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:'1000mg',dRu:'1000мг',dTr:'1000mg'},{t:"Μεσημεριανό",d:'1000mg',dRu:'1000мг',dTr:'1000mg'}]},
 {id:'coq10', name:'CoQ10',                nameRu:'CoQ10',                      nameTr:'CoQ10',                     dose:'100-200mg',     doseRu:'100-200мг',     doseTr:'100-200mg',     cat:'Βιταμίνες & Μέταλλα', timing:[{t:"Με το πρωινό",d:'100-200mg',dRu:'100-200мг',dTr:'100-200mg'}]},
 {id:'hmb',    name:'HMB',                nameRu:'HMB',                        nameTr:'HMB',                        dose:'1g × 3/ημέρα',  doseRu:'1г × 3/день',   doseTr:'1g × günde 3',  cat:'Αμινοξέα & Πρωτεΐνες',timing:[{t:"Με το πρωινό",d:'1g',dRu:'1г',dTr:'1g'},{t:"Μεσημεριανό",d:'1g',dRu:'1г',dTr:'1g'},{t:"Βραδινό",d:'1g',dRu:'1г',dTr:'1g'}]},
 {id:'bcaa',   name:'Αμινοξέα / BCAA',    nameEn:'Amino Acids / BCAA',nameRu:'Аминокислоты / BCAA',       nameTr:'Amino Asitler / BCAA',      dose:'',              cat:'Αμινοξέα & Πρωτεΐνες',timing:[{t:"Πριν προπόνηση (30')",d:''}]},
 ...
 {id:'l_carn', name:'Λ-Καρνιτίνη',        nameEn:'L-Carnitine',       nameRu:'L-карнитин',                nameTr:'L-Karnitin',                dose:'3g',            doseRu:'3г',            doseTr:'3g',            cat:'Pre-Workout',          timing:[{t:"Πριν προπόνηση (30')",d:'3g',dRu:'3г',dTr:'3g'}]},
 {id:'creatine',name:'Κρεατίνη',          nameEn:'Creatine',          nameRu:'Креатин',                   nameTr:'Kreatin',                   dose:'3-5g',          doseRu:'3-5г',          doseTr:'3-5g',          cat:'Pre-Workout',          timing:[{t:"Αμέσως μετά προπόνηση",d:'3-5g',dRu:'3-5г',dTr:'3-5g'}]},
 ...
 {id:'ecdy',   name:'Ecdysterone',         nameRu:'Экдистерон',                 nameTr:'Ekdisteron',                 dose:'',              cat:'Αναβολικά & Ορμόνες', timing:[{t:"Αμέσως μετά προπόνηση",d:''}]},
 {id:'hgh',    name:'HGH Boost',           nameRu:'HGH Boost',                  nameTr:'HGH Boost',                  dose:'',              cat:'Αναβολικά & Ορμόνες', timing:[{t:"Πριν τον ύπνο",d:''}]},
 {id:'antiflam',name:'Αντιφλεγμονώδες',   nameEn:'Anti-inflammatory', nameRu:'Противовоспалительное',     nameTr:'Anti-enflamatuar',          dose:'',              cat:'Αναβολικά & Ορμόνες', timing:[{t:"Αμέσως μετά προπόνηση",d:''}]},
 {id:'htp',    name:'5-HTP',               nameRu:'5-HTP',                      nameTr:'5-HTP',                      dose:'',              cat:'Ύπνος & Αποκατάσταση',timing:[{t:"Πριν τον ύπνο",d:''}]},
 {id:'gaba',   name:'GABA',                nameRu:'ГАМК (GABA)',                nameTr:'GABA',                       dose:'',              cat:'Ύπνος & Αποκατάσταση',timing:[{t:"Πριν τον ύπνο",d:''}]},
 {id:'zma',    name:'ZMA',                 nameRu:'ZMA',                        nameTr:'ZMA',                        dose:'',              cat:'Ύπνος & Αποκατάσταση',timing:[{t:"Πριν τον ύπνο",d:''}]},
 {id:'valerian',name:'Βαλεριάνα',          nameEn:'Valerian',          nameRu:'Валериана',                 nameTr:'Kediotu',                   dose:'',              cat:'Ύπνος & Αποκατάσταση',timing:[{t:"Πριν τον ύπνο",d:''}]}
];
var MACRO_PRESETS={
...
/* ── "Μεσογειακή Διατροφή" — high-protein (~30/40/30) Mediterranean template, ~2500kcal
   baseline. Weekly protein rotation: 2x red meat (w/ big salad), 2x fish+quinoa (≥1 fatty),
   2x chicken patty, rest chicken breast; 2x legumes as a lunch (never dinner); flax/chia in
   2 breakfasts; nuts daily; olive oil ~3 tbsp/day. genPlan()'s scalePlan() rescales this
   linearly to each client's real kcal/macro target, same as the kcalNNNN templates above. ── */
mediterranean:[
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:110},{n:'Ψωμί ολικής άλεσης',g:60},{n:'Αβοκάντο',g:40},{n:'Πορτοκάλι',g:150},{n:'Λιναρόσπορος',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Αμύγδαλα',g:20},{n:'Μήλο',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο μπιφτέκι',g:200},{n:'Κινόα (βρ.)',g:150},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μούρα',g:100}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Γλυκοπατάτα',g:200},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:70},{n:'Γάλα πλήρες',g:200},{n:'Μπανάνα',g:100},{n:'Chia seeds',g:10},{n:'Μέλι άβραστο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:120},{n:'Φράουλες',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:250},{n:'Ψωμί σίκαλης',g:50},{n:'Σαλάτα εποχής',g:180},{n:'Τυρί φέτα',g:25},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Καρύδια',g:20},{n:'Μήλο',g:120}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:180},{n:'Κινόα (βρ.)',g:150},{n:'Σαλάτα εποχής',g:180},{n:'Ελιές',g:15},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Γιαούρτι 2%',g:220},{n:'Γκρανόλα χωρίς ζάχαρη',g:45},{n:'Μπανάνα',g:100},{n:'Αμύγδαλα',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:180},{n:'Cottage cheese',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:180},{n:'Σαλάτα εποχής',g:250},{n:'Ψωμί σίκαλης',g:50},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:170},{n:'Μούρα',g:100}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:170},{n:'Πλιγούρι (βρ.)',g:150},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:110},{n:'Ψωμί σίκαλης',g:60},{n:'Φυστικοβούτυρο',g:15},{n:'Φράουλες',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:120},{n:'Καρύδια',g:15}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:190},{n:'Ρύζι καστανό (βρ.)',g:180},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:180},{n:'Μήλο',g:100}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο μπιφτέκι',g:180},{n:'Κριθαράκι (βρ.)',g:160},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Γκρανόλα χωρίς ζάχαρη',g:45},{n:'Γιαούρτι 2%',g:200},{n:'Κεράσια',g:120},{n:'Αμύγδαλα',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:120},{n:'Φράουλες',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:200},{n:'Κινόα (βρ.)',g:150},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:120},{n:'Καρύδια',g:15}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Γλυκοπατάτα',g:190},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:110},{n:'Ψωμί ολικής άλεσης',g:60},{n:'Αβοκάντο',g:40},{n:'Πορτοκάλι',g:150}]},{name:'Ενδιάμεσο',foods:[{n:'Αμύγδαλα',g:20},{n:'Πορτοκάλι',g:150}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Ρύζι άσπρο (βρ.)',g:170},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μούρα',g:100}]},{name:'Βραδινό',foods:[{n:'Ελεύθερο γεύμα',g:0}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:70},{n:'Γιαούρτι 2%',g:200},{n:'Μούρα',g:100},{n:'Μέλι άβραστο',g:10},{n:'Καρύδια',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:180},{n:'Cottage cheese',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Μπριζόλα άπαχη',g:180},{n:'Πλιγούρι (βρ.)',g:100},{n:'Γιαούρτι 2%',g:150},{n:'Σαλάτα εποχής',g:100},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:170},{n:'Μήλο',g:120}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:190},{n:'Κινόα (βρ.)',g:150},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:15}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
vegetarian_loss:[
[{name:'Πρωινό',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Βρώμη (ωμή)',g:40},{n:'Μούρα',g:80},{n:'Chia seeds',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:120},{n:'Αμύγδαλα',g:10}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:210},{n:'Ρύζι άσπρο (βρ.)',g:100},{n:'Τομάτες',g:80},{n:'Μπρόκολο',g:100},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:100},{n:'Ρυζογκοφρέτες',g:20}]},{name:'Βραδινό',foods:[{n:'Ρεβίθια',g:200},{n:'Τομάτες',g:120},{n:'Κολοκυθάκια',g:100},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:110},{n:'Ψωμί σίκαλης',g:40},{n:'Αβοκάντο',g:40},{n:'Μήλο',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Φράουλες',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:200},{n:'Κινόα (βρ.)',g:120},{n:'Σπαράγγια',g:120},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:100},{n:'Αμύγδαλα',g:10}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:220},{n:'Κολοκυθάκια',g:150},{n:'Σπανάκι',g:80},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:50},{n:'Γάλα πλήρες',g:200},{n:'Μπανάνα',g:80},{n:'Chia seeds',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:55},{n:'Πορτοκάλι',g:150}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:220},{n:'Μπρόκολο',g:120},{n:'Τυρί φέτα',g:20},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:25},{n:'Φυστικοβούτυρο',g:20}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:200},{n:'Γλυκοπατάτα',g:130},{n:'Σπανάκι',g:80},{n:'Ελαιόλαδο',g:8}]}],
...
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:110},{n:'Ψωμί σίκαλης',g:40},{n:'Φυστικοβούτυρο',g:20},{n:'Μπανάνα',g:100}]},{name:'Ενδιάμεσο',foods:[{n:'Energy Bites (FYH)',g:55},{n:'Πορτοκάλι',g:150}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:240},{n:'Ρύζι άσπρο (βρ.)',g:100},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Μπανάνα',g:80}]},{name:'Βραδινό',foods:[{n:'Hummus',g:120},{n:'Ψάρι - SKIP',g:0},{n:'Τομάτες',g:100},{n:'Τυρί φέτα',g:20},{n:'Ελιές',g:15},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:50},{n:'Γιαούρτι 2%',g:200},{n:'Κεράσια',g:100},{n:'Καρύδια',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:120},{n:'Cottage cheese',g:80}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:200},{n:'Κινόα (βρ.)',g:120},{n:'Σπανάκι',g:100},{n:'Ελαιόλαδο',g:8},{n:'Ελιές',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:20},{n:'Αβοκάντο',g:40},{n:'Τομάτες',g:80}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:200},{n:'Γλυκοπατάτα',g:150},{n:'Μπρόκολο',g:100},{n:'Ελαιόλαδο',g:8}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
...
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:150},{n:'Ψωμί ολικής άλεσης',g:40},{n:'Αβοκάντο',g:40},{n:'Μήλο',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα καρύδας',g:150},{n:'Φράουλες',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:200},{n:'Κινόα (βρ.)',g:120},{n:'Σπαράγγια',g:120},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:100},{n:'Σπόροι κολοκύνθης',g:15}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:220},{n:'Κολοκυθάκια',g:150},{n:'Σπανάκι',g:80},{n:'Ελαιόλαδο',g:8}]}],
...
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:140},{n:'Ψωμί σίκαλης',g:40},{n:'Αβοκάντο',g:40},{n:'Πορτοκάλι',g:150}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:150},{n:'Μήλο',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:220},{n:'Ρύζι καστανό (βρ.)',g:120},{n:'Φασολάκια',g:130},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:90},{n:'Μούρα',g:80}]},{name:'Βραδινό',foods:[{n:'Φακές',g:220},{n:'Πλιγούρι (βρ.)',g:120},{n:'Μελιτζάνες',g:130},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Peanut Butter & Jelly Smoothie Bowl',g:346}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:150},{n:'Φιστίκια',g:15}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:220},{n:'Μανιτάρια',g:100},{n:'Ταχίνι',g:10},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:150},{n:'Φράουλες',g:100}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:240},{n:'Σπανάκι',g:100},{n:'Τομάτες',g:80},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:140},{n:'Ψωμί ολικής άλεσης',g:40},{n:'Φυστικοβούτυρο',g:20},{n:'Μπανάνα',g:100}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:55},{n:'Πορτοκάλι',g:150}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:240},{n:'Ρύζι άσπρο (βρ.)',g:100},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα αμυγδάλου',g:150},{n:'Μπανάνα',g:80}]},{name:'Βραδινό',foods:[{n:'Hummus',g:140},{n:'Πίτα αραβική',g:60},{n:'Τομάτες',g:100},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:8}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:50},{n:'Γάλα καρύδας',g:200},{n:'Κεράσια',g:100},{n:'Chia seeds',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:120},{n:'Αμύγδαλα',g:15}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:200},{n:'Κινόα (βρ.)',g:120},{n:'Σπανάκι',g:100},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:20},{n:'Αβοκάντο',g:40},{n:'Τομάτες',g:80}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:200},{n:'Γλυκοπατάτα',g:150},{n:'Μπρόκολο',g:100},{n:'Ελαιόλαδο',g:8}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
...
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:185},{n:'Ψωμί σίκαλης',g:75},{n:'Φυστικοβούτυρο',g:40},{n:'Μπανάνα',g:165}]},{name:'Ενδιάμεσο',foods:[{n:'Energy Bites (FYH)',g:100},{n:'Πορτοκάλι',g:240}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:395},{n:'Ρύζι άσπρο (βρ.)',g:170},{n:'Κολοκυθάκια',g:240},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:250},{n:'Μπανάνα',g:135}]},{name:'Βραδινό',foods:[{n:'Hummus',g:200},{n:'Ψάρι - SKIP',g:0},{n:'Τομάτες',g:165},{n:'Τυρί φέτα',g:40},{n:'Ελιές',g:25},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:80},{n:'Γιαούρτι 2%',g:330},{n:'Κεράσια',g:165},{n:'Καρύδια',g:20}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:200},{n:'Cottage cheese',g:150}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:330},{n:'Κινόα (βρ.)',g:200},{n:'Σπανάκι',g:165},{n:'Ελαιόλαδο',g:15},{n:'Ελιές',g:25}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:40},{n:'Αβοκάντο',g:65},{n:'Τομάτες',g:135}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:330},{n:'Γλυκοπατάτα',g:240},{n:'Μπρόκολο',g:165},{n:'Ελαιόλαδο',g:15}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// KETOGENIC MILD — Ήπια απώλεια (+15%) — Low-carb, high-fat foods only
// ══════════════════════════════════════════════════════════════════════════════
ketogenic_mild:[
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:150},{n:'Αβοκάντο',g:60},{n:'Σπανάκι',g:100},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:50},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:180},{n:'Μπρόκολο',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:100},{n:'Μέλι άβραστο',g:5}]},{name:'Βραδινό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:180},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:140},{n:'Ψωμί ολικής άλεσης',g:20},{n:'Βούτυρο',g:10},{n:'Τομάτες',g:80}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:100},{n:'Φουντούκια',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:50},{n:'Ελιές',g:25}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:200},{n:'Αγγούρι',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:160},{n:'Βούτυρο',g:12},{n:'Μανιτάρια',g:100},{n:'Αλάτι',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:80},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Σπανάκι',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:50},{n:'Καρύδια',g:20}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Μπρόκολο',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:145},{n:'Σολομός (ψητός)',g:80},{n:'Αβοκάντο',g:50},{n:'Αγγούρι',g:80}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:120},{n:'Μέλι άβραστο',g:5}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:180},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:50},{n:'Ελιές',g:30}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:200},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:140},{n:'Κρέμα γάλακτος',g:50},{n:'Μανιτάρια',g:100},{n:'Τυρί φέτα',g:30}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:100},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Μπρόκολο',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:120},{n:'Καρύδια',g:20}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Σπανάκι',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:150},{n:'Σολομός (ψητός)',g:70},{n:'Αβοκάντο',g:55},{n:'Τομάτες',g:80}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:50},{n:'Ελιές',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:190},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:120},{n:'Μέλι άβραστο',g:5}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:200},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:155},{n:'Βούτυρο',g:12},{n:'Μανιτάρια',g:120},{n:'Τυρί φέτα',g:30}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:90},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:210},{n:'Μπρόκολο',g:160},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:120},{n:'Καρύδια',g:25}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:210},{n:'Σπανάκι',g:160},{n:'Ελαιόλαδο',g:10}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// KETOGENIC MAINTAIN — Διατήρηση (+40%)
// ══════════════════════════════════════════════════════════════════════════════
ketogenic_maintain:[
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:180},{n:'Αβοκάντο',g:70},{n:'Σπανάκι',g:120},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:60},{n:'Αμύγδαλα',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:220},{n:'Μπρόκολο',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:130},{n:'Μέλι άβραστο',g:7}]},{name:'Βραδινό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:220},{n:'Κολοκυθάκια',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:170},{n:'Ψωμί ολικής άλεσης',g:25},{n:'Βούτυρο',g:12},{n:'Τομάτες',g:100}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:130},{n:'Φουντούκια',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:240},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:60},{n:'Ελιές',g:30}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:240},{n:'Αγγούρι',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:190},{n:'Βούτυρο',g:14},{n:'Μανιτάρια',g:120},{n:'Αλάτι',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:100},{n:'Αμύγδαλα',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:240},{n:'Σπανάκι',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:60},{n:'Καρύδια',g:25}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:240},{n:'Μπρόκολο',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:175},{n:'Σολομός (ψητός)',g:100},{n:'Αβοκάντο',g:60},{n:'Αγγούρι',g:100}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:150},{n:'Μέλι άβραστο',g:7}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:220},{n:'Κολοκυθάκια',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:60},{n:'Ελιές',g:35}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:240},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:170},{n:'Κρέμα γάλακτος',g:60},{n:'Μανιτάρια',g:120},{n:'Τυρί φέτα',g:40}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:120},{n:'Αμύγδαλα',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:240},{n:'Μπρόκολο',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Καρύδια',g:25}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:240},{n:'Σπανάκι',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:180},{n:'Σολομός (ψητός)',g:85},{n:'Αβοκάντο',g:65},{n:'Τομάτες',g:100}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:60},{n:'Ελιές',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:230},{n:'Κολοκυθάκια',g:180},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:150},{n:'Μέλι άβραστο',g:7}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:240},{n:'Σαλάτα εποχής',g:180},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:185},{n:'Βούτυρο',g:14},{n:'Μανιτάρια',g:140},{n:'Τυρί φέτα',g:40}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:110},{n:'Αμύγδαλα',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:250},{n:'Μπρόκολο',g:190},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Καρύδια',g:30}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:250},{n:'Σπανάκι',g:190},{n:'Ελαιόλαδο',g:12}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// KETOGENIC GAIN — Αύξηση μάζας (+65%)
// ══════════════════════════════════════════════════════════════════════════════
ketogenic_gain:[
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:210},{n:'Αβοκάντο',g:85},{n:'Σπανάκι',g:140},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:70},{n:'Αμύγδαλα',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:260},{n:'Μπρόκολο',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:160},{n:'Μέλι άβραστο',g:10}]},{name:'Βραδινό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:260},{n:'Κολοκυθάκια',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:200},{n:'Ψωμί ολικής άλεσης',g:30},{n:'Βούτυρο',g:14},{n:'Τομάτες',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:160},{n:'Φουντούκια',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:280},{n:'Σαλάτα εποχής',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:70},{n:'Ελιές',g:40}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:280},{n:'Αγγούρι',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:220},{n:'Βούτυρο',g:16},{n:'Μανιτάρια',g:140},{n:'Αλάτι',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:120},{n:'Αμύγδαλα',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:280},{n:'Σπανάκι',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:70},{n:'Καρύδια',g:35}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:280},{n:'Μπρόκολο',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:205},{n:'Σολομός (ψητός)',g:120},{n:'Αβοκάντο',g:70},{n:'Αγγούρι',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:180},{n:'Μέλι άβραστο',g:10}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:260},{n:'Κολοκυθάκια',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:70},{n:'Ελιές',g:40}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:280},{n:'Σαλάτα εποχής',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:200},{n:'Κρέμα γάλακτος',g:70},{n:'Μανιτάρια',g:140},{n:'Τυρί φέτα',g:50}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:140},{n:'Αμύγδαλα',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:280},{n:'Μπρόκολο',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:180},{n:'Καρύδια',g:35}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:280},{n:'Σπανάκι',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:210},{n:'Σολομός (ψητός)',g:100},{n:'Αβοκάντο',g:75},{n:'Τομάτες',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Τυρί φέτα',g:70},{n:'Ελιές',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:270},{n:'Κολοκυθάκια',g:210},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:180},{n:'Μέλι άβραστο',g:10}]},{name:'Βραδινό',foods:[{n:'Λαβράκι (ψητό)',g:280},{n:'Σαλάτα εποχής',g:210},{n:'Ελαιόλαδο',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:215},{n:'Βούτυρο',g:16},{n:'Μανιτάρια',g:160},{n:'Τυρί φέτα',g:50}]},{name:'Ενδιάμεσο',foods:[{n:'Αβοκάντο',g:130},{n:'Αμύγδαλα',g:40}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:290},{n:'Μπρόκολο',g:220},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:180},{n:'Καρύδια',g:40}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:290},{n:'Σπανάκι',g:220},{n:'Ελαιόλαδο',g:14}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// VEGAN MILD — Ήπια απώλεια (+15%)
// ══════════════════════════════════════════════════════════════════════════════
vegan_mild:[
[{name:'Πρωινό',foods:[{n:'Γάλα σόγιας',g:230},{n:'Βρώμη (ωμή)',g:45},{n:'Μούρα',g:95},{n:'Σπόροι λιναρόσπορου',g:6}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:140},{n:'Αμύγδαλα',g:20}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:250},{n:'Ρύζι άσπρο (βρ.)',g:120},{n:'Μπρόκολο',g:170},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:95},{n:'Ρυζογκοφρέτες',g:25}]},{name:'Βραδινό',foods:[{n:'Ρεβίθια',g:230},{n:'Τομάτες',g:115},{n:'Αγγούρι',g:115},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:170},{n:'Ψωμί ολικής άλεσης',g:50},{n:'Αβοκάντο',g:45},{n:'Μήλο',g:140}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα καρύδας',g:170},{n:'Φράουλες',g:115}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:230},{n:'Κινόα (βρ.)',g:140},{n:'Σπαράγγια',g:140},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:115},{n:'Σπόροι κολοκύνθης',g:18}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:250},{n:'Κολοκυθάκια',g:170},{n:'Σπανάκι',g:95},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:60},{n:'Γάλα αμυγδάλου',g:230},{n:'Μπανάνα',g:95},{n:'Chia seeds',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:65},{n:'Πορτοκάλι',g:170}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:250},{n:'Μπρόκολο',g:140},{n:'Ταχίνι',g:18},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:30},{n:'Φυστικοβούτυρο',g:25}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:230},{n:'Γλυκοπατάτα',g:150},{n:'Σπανάκι',g:95},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:160},{n:'Ψωμί σίκαλης',g:50},{n:'Αβοκάντο',g:45},{n:'Πορτοκάλι',g:170}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:170},{n:'Μήλο',g:115}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:250},{n:'Ρύζι καστανό (βρ.)',g:140},{n:'Φασολάκια',g:150},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:105},{n:'Μούρα',g:95}]},{name:'Βραδινό',foods:[{n:'Φακές',g:250},{n:'Πλιγούρι (βρ.)',g:140},{n:'Μελιτζάνες',g:150},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Γάλα καρύδας',g:230},{n:'Βρώμη (ωμή)',g:45},{n:'Φράουλες',g:115},{n:'Σπόροι κολοκύνθης',g:18}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:170},{n:'Φιστίκια',g:18}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:250},{n:'Μανιτάρια',g:115},{n:'Ταχίνι',g:12},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:170},{n:'Φράουλες',g:115}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:270},{n:'Σπανάκι',g:115},{n:'Τομάτες',g:95},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:160},{n:'Ψωμί ολικής άλεσης',g:50},{n:'Φυστικοβούτυρο',g:25},{n:'Μπανάνα',g:115}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:65},{n:'Πορτοκάλι',g:170}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:270},{n:'Ρύζι άσπρο (βρ.)',g:120},{n:'Κολοκυθάκια',g:170},{n:'Ελαιόλαδο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα αμυγδάλου',g:170},{n:'Μπανάνα',g:95}]},{name:'Βραδινό',foods:[{n:'Hummus',g:160},{n:'Πίτα αραβική',g:70},{n:'Τομάτες',g:115},{n:'Σαλάτα εποχής',g:170},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:60},{n:'Γάλα καρύδας',g:230},{n:'Κεράσια',g:115},{n:'Chia seeds',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:140},{n:'Αμύγδαλα',g:20}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:230},{n:'Κινόα (βρ.)',g:140},{n:'Σπανάκι',g:115},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:25},{n:'Αβοκάντο',g:45},{n:'Τομάτες',g:95}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:230},{n:'Γλυκοπατάτα',g:170},{n:'Μπρόκολο',g:115},{n:'Ελαιόλαδο',g:10}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// VEGAN MAINTAIN — Διατήρηση (+40%)
// ══════════════════════════════════════════════════════════════════════════════
vegan_maintain:[
[{name:'Πρωινό',foods:[{n:'Γάλα σόγιας',g:280},{n:'Βρώμη (ωμή)',g:55},{n:'Μούρα',g:115},{n:'Σπόροι λιναρόσπορου',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:170},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:310},{n:'Ρύζι άσπρο (βρ.)',g:145},{n:'Μπρόκολο',g:205},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:115},{n:'Ρυζογκοφρέτες',g:30}]},{name:'Βραδινό',foods:[{n:'Ρεβίθια',g:280},{n:'Τομάτες',g:140},{n:'Αγγούρι',g:140},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:210},{n:'Ψωμί ολικής άλεσης',g:60},{n:'Αβοκάντο',g:55},{n:'Μήλο',g:170}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα καρύδας',g:200},{n:'Φράουλες',g:140}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:280},{n:'Κινόα (βρ.)',g:170},{n:'Σπαράγγια',g:170},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:140},{n:'Σπόροι κολοκύνθης',g:22}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:310},{n:'Κολοκυθάκια',g:205},{n:'Σπανάκι',g:115},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:70},{n:'Γάλα αμυγδάλου',g:280},{n:'Μπανάνα',g:115},{n:'Chia seeds',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:80},{n:'Πορτοκάλι',g:205}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:310},{n:'Μπρόκολο',g:170},{n:'Ταχίνι',g:22},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:35},{n:'Φυστικοβούτυρο',g:30}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:280},{n:'Γλυκοπατάτα',g:185},{n:'Σπανάκι',g:115},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:195},{n:'Ψωμί σίκαλης',g:60},{n:'Αβοκάντο',g:55},{n:'Πορτοκάλι',g:205}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:200},{n:'Μήλο',g:140}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:310},{n:'Ρύζι καστανό (βρ.)',g:170},{n:'Φασολάκια',g:185},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:130},{n:'Μούρα',g:115}]},{name:'Βραδινό',foods:[{n:'Φακές',g:310},{n:'Πλιγούρι (βρ.)',g:170},{n:'Μελιτζάνες',g:185},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Γάλα καρύδας',g:280},{n:'Βρώμη (ωμή)',g:55},{n:'Φράουλες',g:140},{n:'Σπόροι κολοκύνθης',g:22}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:205},{n:'Φιστίκια',g:22}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:310},{n:'Μανιτάρια',g:140},{n:'Ταχίνι',g:15},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:200},{n:'Φράουλες',g:140}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:335},{n:'Σπανάκι',g:140},{n:'Τομάτες',g:115},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:195},{n:'Ψωμί ολικής άλεσης',g:60},{n:'Φυστικοβούτυρο',g:30},{n:'Μπανάνα',g:140}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:80},{n:'Πορτοκάλι',g:205}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:335},{n:'Ρύζι άσπρο (βρ.)',g:145},{n:'Κολοκυθάκια',g:205},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα αμυγδάλου',g:200},{n:'Μπανάνα',g:115}]},{name:'Βραδινό',foods:[{n:'Hummus',g:200},{n:'Πίτα αραβική',g:80},{n:'Τομάτες',g:140},{n:'Σαλάτα εποχής',g:200},{n:'Ελαιόλαδο',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:70},{n:'Γάλα καρύδας',g:280},{n:'Κεράσια',g:140},{n:'Chia seeds',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:170},{n:'Αμύγδαλα',g:25}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:280},{n:'Κινόα (βρ.)',g:170},{n:'Σπανάκι',g:140},{n:'Ελαιόλαδο',g:14}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:30},{n:'Αβοκάντο',g:55},{n:'Τομάτες',g:115}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:280},{n:'Γλυκοπατάτα',g:205},{n:'Μπρόκολο',g:140},{n:'Ελαιόλαδο',g:12}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
// VEGAN GAIN — Αύξηση μάζας (+65%)
// ══════════════════════════════════════════════════════════════════════════════
vegan_gain:[
[{name:'Πρωινό',foods:[{n:'Γάλα σόγιας',g:330},{n:'Βρώμη (ωμή)',g:65},{n:'Μούρα',g:135},{n:'Σπόροι λιναρόσπορου',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:200},{n:'Αμύγδαλα',g:35}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:365},{n:'Ρύζι άσπρο (βρ.)',g:170},{n:'Μπρόκολο',g:240},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:140},{n:'Ρυζογκοφρέτες',g:40},{n:'Μέλι άβραστο',g:12}]},{name:'Βραδινό',foods:[{n:'Ρεβίθια',g:330},{n:'Τομάτες',g:165},{n:'Αγγούρι',g:165},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:250},{n:'Ψωμί ολικής άλεσης',g:75},{n:'Αβοκάντο',g:65},{n:'Μήλο',g:200}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα καρύδας',g:250},{n:'Φράουλες',g:165}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:330},{n:'Κινόα (βρ.)',g:200},{n:'Σπαράγγια',g:200},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:165},{n:'Σπόροι κολοκύνθης',g:30}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:365},{n:'Κολοκυθάκια',g:240},{n:'Σπανάκι',g:135},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:80},{n:'Γάλα αμυγδάλου',g:330},{n:'Μπανάνα',g:135},{n:'Chia seeds',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:100},{n:'Πορτοκάλι',g:240}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:365},{n:'Μπρόκολο',g:200},{n:'Ταχίνι',g:30},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:45},{n:'Φυστικοβούτυρο',g:40}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:330},{n:'Γλυκοπατάτα',g:215},{n:'Σπανάκι',g:135},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:230},{n:'Ψωμί σίκαλης',g:75},{n:'Αβοκάντο',g:65},{n:'Πορτοκάλι',g:240}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:250},{n:'Μήλο',g:165}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:365},{n:'Ρύζι καστανό (βρ.)',g:200},{n:'Φασολάκια',g:215},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Hummus',g:160},{n:'Μούρα',g:135}]},{name:'Βραδινό',foods:[{n:'Φακές',g:365},{n:'Πλιγούρι (βρ.)',g:200},{n:'Μελιτζάνες',g:215},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Γάλα καρύδας',g:330},{n:'Βρώμη (ωμή)',g:65},{n:'Φράουλες',g:165},{n:'Σπόροι κολοκύνθης',g:30}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:240},{n:'Φιστίκια',g:30}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:365},{n:'Μανιτάρια',g:165},{n:'Ταχίνι',g:20},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα σόγιας',g:250},{n:'Φράουλες',g:165}]},{name:'Βραδινό',foods:[{n:'Φασόλια',g:395},{n:'Σπανάκι',g:165},{n:'Τομάτες',g:135},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Tofu (φυσικό)',g:230},{n:'Ψωμί ολικής άλεσης',g:75},{n:'Φυστικοβούτυρο',g:40},{n:'Μπανάνα',g:165}]},{name:'Ενδιάμεσο',foods:[{n:'Dark Choc Oat Bites',g:100},{n:'Πορτοκάλι',g:240}]},{name:'Μεσημεριανό',foods:[{n:'Tofu (φυσικό)',g:395},{n:'Ρύζι άσπρο (βρ.)',g:170},{n:'Κολοκυθάκια',g:240},{n:'Ελαιόλαδο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα αμυγδάλου',g:250},{n:'Μπανάνα',g:135}]},{name:'Βραδινό',foods:[{n:'Hummus',g:240},{n:'Πίτα αραβική',g:95},{n:'Τομάτες',g:165},{n:'Σαλάτα εποχής',g:240},{n:'Ελαιόλαδο',g:15}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:80},{n:'Γάλα καρύδας',g:330},{n:'Κεράσια',g:165},{n:'Chia seeds',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:200},{n:'Αμύγδαλα',g:35}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:330},{n:'Κινόα (βρ.)',g:200},{n:'Σπανάκι',g:165},{n:'Ελαιόλαδο',g:16}]},{name:'Ενδιάμεσο',foods:[{n:'Ρυζογκοφρέτες',g:40},{n:'Αβοκάντο',g:65},{n:'Τομάτες',g:135}]},{name:'Βραδινό',foods:[{n:'Tofu (φυσικό)',g:330},{n:'Γλυκοπατάτα',g:240},{n:'Μπρόκολο',g:165},{n:'Ελαιόλαδο',g:15}]}]
],
...
[{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Κινόα (βρ.)',g:200},{n:'Σαλάτα εποχής',g:200},{n:'Ελιές',g:20},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:200},{n:'Αμύγδαλα',g:30},{n:'Μούρα',g:120}]},{name:'Βραδινό',foods:[{n:'Γιαούρτι 2%',g:250},{n:'Βρώμη (ωμή)',g:70},{n:'Κεράσια',g:150},{n:'Καρύδια',g:20}]}],
...
[{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:220},{n:'Ρύζι άσπρο (βρ.)',g:200},{n:'Μπρόκολο',g:160},{n:'Τομάτες',g:100},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Φυστικοβούτυρο',g:25},{n:'Πορτοκάλι',g:150}]},{name:'Βραδινό',foods:[{n:'Αυγά (ολόκληρα)',g:170},{n:'Ψωμί σίκαλης',g:60},{n:'Αβοκάντο',g:50},{n:'Τομάτες',g:80}]}]
],
/* ── ORTHODOX FASTING: Plant-based (no meat, fish, dairy, eggs, animal oil) ── */
orthodox_fasting:[
/* ✅ Αντικαταστάθηκε 2026-07-30 — πλήρες χειροποίητο 7ήμερο νηστίσιμο πρότυπο 2000kcal
   του χρήστη (πρωτεΐνη ~65-73g/17%, υδατ. ~245-265g/55%, λίπος ~68-76g/26-28%,
   μαγείρεμα χωρίς λάδι). Ενσωματώθηκε ως ΜΟΝΙΜΟ default για orthodox_fasting,
   ανεξάρτητα από συγκεκριμένο διαιτολόγο/σύνδεση — βλ. compatibility audit +
   κλιμάκωση 2000kcal της συνεδρίας. Το παλιό πρότυπο (χαμηλότερο σε kcal, με
   Ελαιόλαδο σε κάθε γεύμα) διατηρείται στο git ιστορικό αν χρειαστεί επαναφορά. */
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:70},{n:'Γάλα σόγιας (χωρίς ζάχαρη)',g:295},{n:'Ταχίνι',g:18},{n:'Κανέλα',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:140},{n:'Καρύδια',g:29}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:235},{n:'Τομάτες',g:115},{n:'Αγγούρι',g:115},{n:'Κρεμμύδι',g:23},{n:'Ψωμί ολικής άλεσης',g:35},{n:'Ελιές πράσινες',g:29}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:150},{n:'Αμύγδαλα',g:23}]},{name:'Βραδινό',foods:[{n:'Πατάτες',g:295},{n:'Μπρόκολο',g:235},{n:'Ταχίνι',g:35},{n:'Λεμόνι (χυμός)',g:12}]}],
[{name:'Πρωινό',foods:[{n:'Ψωμί ολικής άλεσης',g:80},{n:'Ταχίνι',g:41},{n:'Μέλι άβραστο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:275},{n:'Κάσιους',g:27}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:275},{n:'Σπανάκι',g:135},{n:'Τομάτες',g:110},{n:'Δεντρολίβανο',g:1},{n:'Ψωμί ολικής άλεσης',g:41}]},{name:'Ενδιάμεσο',foods:[{n:'Καρότα',g:135},{n:'Αγγούρι',g:70},{n:'Χούμους σπιτικό',g:55}]},{name:'Βραδινό',foods:[{n:'Κινόα (βρ.)',g:245},{n:'Κολοκυθάκια',g:135},{n:'Πιπεριά κόκκινη',g:110},{n:'Μελιτζάνες',g:95},{n:'Λιναρόσπορος',g:14}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:75},{n:'Γάλα βρώμης (χωρίς ζάχαρη)',g:310},{n:'Μπανάνα',g:125},{n:'Κανέλα',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Καρύδια',g:37},{n:'Αχλάδι',g:175}]},{name:'Μεσημεριανό',foods:[{n:'Γίγαντες (βρ.)',g:275},{n:'Λάχανο',g:100},{n:'Καρότα',g:60},{n:'Λεμόνι (χυμός)',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Τομάτες',g:250},{n:'Αμύγδαλα',g:25},{n:'Ρίγανη',g:1}]},{name:'Βραδινό',foods:[{n:'Ρύζι καστανό (βρ.)',g:225},{n:'Φακές',g:125},{n:'Σπανάκι',g:125},{n:'Ταχίνι',g:19}]}],
[{name:'Πρωινό',foods:[{n:'Ψωμί ολικής άλεσης (φρυγανισμένο)',g:80},{n:'Φυστικοβούτυρο',g:39}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:170},{n:'Γάλα σόγιας (χωρίς ζάχαρη)',g:260}]},{name:'Μεσημεριανό',foods:[{n:'Μαυρομάτικα',g:260},{n:'Σέσκουλα',g:130},{n:'Τομάτες',g:105},{n:'Κρεμμύδι',g:26},{n:'Ψωμί ολικής άλεσης',g:39}]},{name:'Ενδιάμεσο',foods:[{n:'Ηλιόσποροι',g:33},{n:'Μανταρίνι',g:130}]},{name:'Βραδινό',foods:[{n:'Πατάτες',g:325},{n:'Αρακάς (βρ.)',g:195},{n:'Καρότα',g:105},{n:'Ταχίνι',g:26},{n:'Λεμόνι (χυμός)',g:13}]}],
[{name:'Πρωινό',foods:[{n:'Chia seeds',g:16},{n:'Μήλο',g:160},{n:'Αμύγδαλα',g:24},{n:'Καρύδια',g:24}]},{name:'Μεσημεριανό',foods:[{n:'Φακές κόκκινες (βρ.)',g:335},{n:'Ψωμί ολικής άλεσης',g:48},{n:'Ελιές πράσινες',g:40}]},{name:'Ενδιάμεσο',foods:[{n:'Μπανάνα',g:190},{n:'Αμύγδαλα',g:32}]},{name:'Βραδινό',foods:[{n:'Κινόα (βρ.)',g:285},{n:'Κολοκυθάκια',g:160},{n:'Πιπεριά κόκκινη',g:130},{n:'Κρεμμύδι',g:110},{n:'Χούμους σπιτικό',g:72}]}],
[{name:'Πρωινό',foods:[{n:'Ψωμί ολικής άλεσης',g:75},{n:'Ταχίνι',g:38},{n:'Μαρμελάδα χωρίς ζάχαρη',g:19}]},{name:'Ενδιάμεσο',foods:[{n:'Μήλο',g:165},{n:'Καρύδια',g:32}]},{name:'Μεσημεριανό',foods:[{n:'Ρεβίθια',g:255},{n:'Τομάτες',g:130},{n:'Μαϊντανός (φρέσκος)',g:6},{n:'Κρεμμύδι',g:26},{n:'Λεμόνι (χυμός)',g:13},{n:'Ψωμί ολικής άλεσης',g:38}]},{name:'Ενδιάμεσο',foods:[{n:'Καρότα',g:130},{n:'Αγγούρι',g:65},{n:'Χούμους σπιτικό',g:51}]},{name:'Βραδινό',foods:[{n:'Ρύζι καστανό (βρ.)',g:230},{n:'Μαυρομάτικα',g:130},{n:'Σπανάκι',g:130},{n:'Λιναρόσπορος',g:13}]}],
[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:65},{n:'Γάλα βρώμης (χωρίς ζάχαρη)',g:275},{n:'Μήλο',g:110},{n:'Κανέλα',g:2}]},{name:'Ενδιάμεσο',foods:[{n:'Πορτοκάλι',g:220},{n:'Κάσιους',g:22}]},{name:'Μεσημεριανό',foods:[{n:'Γίγαντες (βρ.)',g:240},{n:'Λάχανο',g:65},{n:'Καρότα',g:44},{n:'Λεμόνι (χυμός)',g:11},{n:'Ελιές πράσινες',g:27}]},{name:'Ενδιάμεσο',foods:[{n:'Αχλάδι',g:155},{n:'Καρύδια',g:33}]},{name:'Βραδινό',foods:[{n:'Πατάτες',g:275},{n:'Φακές',g:165},{n:'Μπρόκολο',g:165},{n:'Ταχίνι',g:33}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
...
kids_10_14:[
[{name:'Πρωινό',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Γκρανόλα χωρίς ζάχαρη',g:40},{n:'Μπανάνα',g:120},{n:'Μέλι άβραστο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί ολικής άλεσης',g:60},{n:'Κοτόπουλο στήθος (ψητό)',g:50},{n:'Τομάτες',g:40},{n:'Μαρούλι',g:30},{n:'Cottage cheese',g:20},{n:'Μήλο',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:150},{n:'Ρύζι άσπρο (βρ.)',g:120},{n:'Μπρόκολο',g:130},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Γκρανόλα χωρίς ζάχαρη',g:30},{n:'Πορτοκάλι',g:120}]},{name:'Βραδινό',foods:[{n:'Φακές',g:180},{n:'Ψωμί σίκαλης',g:50},{n:'Σαλάτα εποχής',g:150},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:100},{n:'Ψωμί σίκαλης',g:50},{n:'Τομάτες',g:50},{n:'Πορτοκάλι',g:130}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί ολικής άλεσης',g:60},{n:'Τόνος (κονσέρβα)',g:60},{n:'Αγγούρι',g:50},{n:'Φυστικοβούτυρο',g:15},{n:'Φράουλες',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:150},{n:'Πατάτες',g:150},{n:'Σπανάκι',g:120},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα πλήρες',g:200},{n:'Κράκερ ολικής',g:40},{n:'Μπανάνα',g:100}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:140},{n:'Πλιγούρι (βρ.)',g:120},{n:'Γλυκοπατάτα',g:100},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Βρώμη (ωμή)',g:50},{n:'Γάλα πλήρες',g:200},{n:'Μούρα',g:100},{n:'Μέλι άβραστο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί ολικής άλεσης',g:60},{n:'Κοτόπουλο στήθος (ψητό)',g:50},{n:'Μαρούλι',g:30},{n:'Λάχανο',g:40},{n:'Φυστικοβούτυρο',g:12},{n:'Μήλο',g:130}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:150},{n:'Κινόα (βρ.)',g:110},{n:'Σπαράγγια',g:130},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:170},{n:'Μούρα',g:100},{n:'Κράκερ ολικής',g:25}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο σουβλάκι',g:140},{n:'Ψωμί ολικής άλεσης',g:60},{n:'Σαλάτα εποχής',g:120},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:100},{n:'Ψωμί ολικής άλεσης',g:50},{n:'Αβοκάντο',g:40},{n:'Μπανάνα',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί σίκαλης',g:60},{n:'Μαγιονέζα light',g:15},{n:'Γαλοπούλα στήθος',g:50},{n:'Τομάτες',g:40},{n:'Αγγούρι',g:40},{n:'Φράουλες',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Φακές',g:200},{n:'Ρύζι άσπρο (βρ.)',g:110},{n:'Μπρόκολο',g:130},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα πλήρες',g:200},{n:'Κράκερ ολικής',g:35},{n:'Πορτοκάλι',g:130}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:140},{n:'Ρύζι καστανό (βρ.)',g:120},{n:'Κολοκυθάκια',g:130},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Γκρανόλα χωρίς ζάχαρη',g:45},{n:'Φράουλες',g:100},{n:'Μέλι άβραστο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί ολικής άλεσης',g:60},{n:'Τόνος (κονσέρβα)',g:60},{n:'Λάχανο',g:50},{n:'Αγγούρι',g:40},{n:'Φυστικοβούτυρο',g:15},{n:'Μήλο',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:160},{n:'Πατάτες',g:140},{n:'Σπανάκι',g:120},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:150},{n:'Σταφίδες',g:30},{n:'Αμύγδαλα',g:15}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:140},{n:'Πλιγούρι (βρ.)',g:120},{n:'Σαλάτα εποχής',g:130},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:100},{n:'Ψωμί σίκαλης',g:50},{n:'Φυστικοβούτυρο',g:15},{n:'Μπανάνα',g:130}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί ολικής άλεσης',g:60},{n:'Κοτόπουλο στήθος (ψητό)',g:50},{n:'Τομάτες',g:50},{n:'Φυστικοβούτυρο',g:12},{n:'Πορτοκάλι',g:130}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:160},{n:'Πατάτες',g:140},{n:'Μπρόκολο',g:120},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γάλα πλήρες',g:200},{n:'Κράκερ ολικής',g:40},{n:'Μήλο',g:120}]},{name:'Βραδινό',foods:[{n:'Φακές',g:180},{n:'Ρύζι άσπρο (βρ.)',g:110},{n:'Λάχανο',g:130},{n:'Ελαιόλαδο',g:5}]}],

[{name:'Πρωινό',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Γκρανόλα χωρίς ζάχαρη',g:45},{n:'Μούρα',g:120},{n:'Μέλι άβραστο',g:10}]},{name:'Ενδιάμεσο',foods:[{n:'Ψωμί σίκαλης',g:60},{n:'Αυγά (ολόκληρα)',g:50},{n:'Μαρούλι',g:30},{n:'Τομάτες',g:40},{n:'Φυστικοβούτυρο',g:15},{n:'Φράουλες',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Λαβράκι (ψητό)',g:160},{n:'Πλιγούρι (βρ.)',g:120},{n:'Γλυκοπατάτα',g:100},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:170},{n:'Μούρα',g:100},{n:'Γκρανόλα χωρίς ζάχαρη',g:30}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:140},{n:'Ρύζι καστανό (βρ.)',g:120},{n:'Σπανάκι',g:130},{n:'Ελαιόλαδο',g:5}]}]
],
// ══════════════════════════════════════════════════════════════════════════════
...
football:[
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:140},{n:'Ψωμί ολικής άλεσης',g:80},{n:'Μπανάνα',g:150},{n:'Ελαιόλαδο',g:8}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Energy Bites (FYH)',g:70},{n:'Πορτοκάλι',g:180}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Ρύζι καστανό (βρ.)',g:220},{n:'Μπρόκολο',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:150},{n:'Μούρα',g:100},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:180},{n:'Γλυκοπατάτα',g:240},{n:'Σπανάκι',g:100},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Γκρανόλα χωρίς ζάχαρη',g:60},{n:'Γάλα πλήρες',g:250},{n:'Φράουλες',g:140},{n:'Μέλι άβραστο',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:80},{n:'Ρυζογκοφρέτες',g:35},{n:'Τομάτες',g:80}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Κινόα (βρ.)',g:200},{n:'Σπαράγγια',g:140},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μπανάνα',g:120},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Φακές',g:240},{n:'Κοτόπουλο στήθος (ψητό)',g:150},{n:'Τυρί φέτα',g:25},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:140},{n:'Ψωμί σίκαλης',g:90},{n:'Αβοκάντο',g:60},{n:'Μπανάνα',g:120}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:160},{n:'Φράουλες',g:120},{n:'Chia seeds',g:10}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Μακαρόνια (βρ.)',g:200},{n:'Τομάτες',g:150},{n:'Τυρί φέτα',g:20},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μπανάνα',g:130},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Σολομός (ψητός)',g:180},{n:'Κριθαράκι (βρ.)',g:200},{n:'Κολοκυθάκια',g:150},{n:'Ελιές',g:20},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Γκρανόλα χωρίς ζάχαρη',g:60},{n:'Γιαούρτι 2%',g:220},{n:'Μούρα',g:150},{n:'Μέλι άβραστο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Energy Bites (FYH)',g:75},{n:'Μήλο',g:180}]},{name:'Μεσημεριανό',foods:[{n:'Βοδινό άπαχο (ψητό)',g:200},{n:'Ρύζι άσπρο (βρ.)',g:220},{n:'Μανιτάρια',g:130},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μπανάνα',g:120},{n:'Καρύδια',g:20}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Πλιγούρι (βρ.)',g:200},{n:'Σπανάκι',g:120},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:150},{n:'Ψωμί ολικής άλεσης',g:80},{n:'Φυστικοβούτυρο',g:25},{n:'Μπανάνα',g:140}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Dark Choc Oat Bites',g:75},{n:'Πορτοκάλι',g:180}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Κινόα (βρ.)',g:200},{n:'Κολοκυθάκια',g:150},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:160},{n:'Μούρα',g:120},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Ρύζι καστανό (βρ.)',g:220},{n:'Τομάτες',g:120},{n:'Τυρί φέτα',g:20},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Γκρανόλα χωρίς ζάχαρη',g:60},{n:'Γάλα πλήρες',g:250},{n:'Κεράσια',g:140},{n:'Καρύδια',g:15}]},{name:'Ενδιάμεσο',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:80},{n:'Ρυζογκοφρέτες',g:35},{n:'Τομάτες',g:100}]},{name:'Μεσημεριανό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:200},{n:'Μακαρόνια (βρ.)',g:200},{n:'Μπρόκολο',g:150},{n:'Τυρί φέτα',g:20},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:220},{n:'Μπανάνα',g:130},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Γαρίδες (βραστές)',g:220},{n:'Ρύζι άσπρο (βρ.)',g:220},{n:'Σπανάκι',g:100},{n:'Ελιές',g:20},{n:'Ελαιόλαδο',g:10}]}],
[{name:'Πρωινό',foods:[{n:'Αυγά (ολόκληρα)',g:140},{n:'Ψωμί σίκαλης',g:90},{n:'Αβοκάντο',g:50},{n:'Μήλο',g:160}]},{name:'Ενδιάμεσο',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Energy Bites (FYH)',g:70},{n:'Μπανάνα',g:120}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Κριθαράκι (βρ.)',g:200},{n:'Σπαράγγια',g:140},{n:'Ελαιόλαδο',g:12}]},{name:'Ενδιάμεσο',foods:[{n:'Cottage cheese',g:160},{n:'Φράουλες',g:120},{n:'Καρύδια',g:20}]},{name:'Βραδινό',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:180},{n:'Γλυκοπατάτα',g:240},{n:'Σπανάκι',g:120},{n:'Ελαιόλαδο',g:10}]}]
]
};
var MEAL_RECIPES=[
