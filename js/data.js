...
'Μέλι άβραστο':{k:304,p:0.3,c:82,f:0,fi:0.2,cat:'Άλλα',en:'Raw Honey',vegan:false},
'Μαρμελάδα φράουλας':{k:251,p:0.3,c:62,f:0.1,fi:0.9,cat:'Άλλα',en:'Strawberry Jam'},
'Μαρμελάδα χωρίς ζάχαρη':{k:130,p:0.5,c:31,f:0.2,fi:1.5,cat:'Άλλα',en:'Sugar-Free Jam'},
...
'Γάλα σόγιας (χωρίς ζάχαρη)':{k:33,p:3.3,c:1,f:1.8,fi:0.4,cat:'Αυγά/Γαλακτ.',plantBased:true,en:'Soy Milk (unsweetened, fortified)'},
'Γάλα βρώμης':{k:46,p:1.0,c:8.0,f:1.5,fi:0.5,cat:'Αυγά/Γαλακτ.',plantBased:true,en:'Oat Milk'},
'Γάλα βρώμης (χωρίς ζάχαρη)':{k:40,p:1.0,c:6.5,f:1.5,fi:0.5,cat:'Αυγά/Γαλακτ.',plantBased:true,en:'Oat Milk (unsweetened, fortified)'},
...
'Ψωμί ολικής άλεσης (φρυγανισμένο)':{k:300,p:11,c:50,f:4,fi:8,cat:'Δημητριακά',en:'Whole Wheat Bread (toasted)'},
...
'Σέσκουλα':{k:19,p:1.8,c:3.7,f:0.2,fi:1.6,cat:'Λαχανικά',en:'Swiss Chard'},
...
'Αυγολέμονο Κυπριακό':{k:82,p:7,c:8,f:3.5,fi:0.4,cat:'Συνταγές FYH',containsCats:['Αυγά/Γαλακτ.'],en:'Cypriot Avgolemono'},
...
'Ψάρι στο Φούρνο (FYH)':{k:165,p:19,c:0,f:10,fi:0.8,cat:'Συνταγές FYH',containsCats:['Ψάρια'],en:'Baked Fish (FYH)'},
...
'Λιγκουίνι με Γαρίδες (Πετρετζίκης)':{k:589,p:31,c:65,f:22,fi:4.8,cat:'Συνταγές FYH',containsCats:['Ψάρια'],en:'Linguine with Shrimp (Petretzikis)'},
...
'Αμπελόφυλλα (τουρσί)':{k:93,p:2.3,c:17.1,f:2.1,fi:4.6,cat:'Λαχανικά',en:'Grape Leaves (brined)'},
};
var FOOD_PAIRING_DB={
  // ── PROTEINS ────────────────────────────────────────────────────────────────
...
var MEAL_RECIPES=[
  ...
  // Πηγή έμπνευσης: Άκης Πετρετζίκης (akispetretzikis.com) — παραλλαγή/απόδοση, όχι αυτούσιο κείμενο
  {id:'vegan_stuffed_zucchini_lemon',name:'Vegan Γεμιστά Κολοκυθάκια με Σάλτσα Λεμονιού',foods:[
    {n:'Κολοκυθάκια (γεμιστά)',g:280},{n:'Ρύζι άσπρο (βρ.)',g:35},{n:'Μανιτάρια',g:50},{n:'Σάλτσα λεμονιού (φυτική)',g:75},{n:'Ελαιόλαδο',g:13}
  ],kcal:445,macro:{p:8.7,f:27,c:39},tags:['Vegan','Λαχανικά','Ελληνικό'],prepTimeMin:50,
  instructions:'Κολοκυθάκια: Κόβουμε το πάνω μέρος σαν καπάκι και αδειάζουμε προσεκτικά τη σάρκα με κουτάλι, χωρίς να τρυπήσουμε τα τοιχώματα. Ραντίζουμε εσωτερικά-εξωτερικά με ελαιόλαδο, αλάτι και πιπέρι.\n\nΓέμιση: Πολτοποιούμε τη σάρκα στον πολυκόφτη. Σοτάρουμε κρεμμύδι με θυμάρι, προσθέτουμε μανιτάρια και σκόρδο, σβήνουμε με λίγο λευκό κρασί. Ρίχνουμε τη σάρκα, νερό, ζωμό λαχανικών και το ρύζι, και σιγοβράζουμε μέχρι να απορροφηθούν τα περισσότερα υγρά. Αποσύρουμε από τη φωτιά και προσθέτουμε άνηθο, μαϊντανό και χυμό λεμονιού.\n\nΨήσιμο: Γεμίζουμε τα κολοκυθάκια, τα τοποθετούμε σε πυρίμαχο σκεύος με λίγο ζωμό λαχανικών, σκεπάζουμε με αλουμινόχαρτο και ψήνουμε στους 180°C (αέρα) για 45-60 λεπτά μέχρι να μαλακώσουν.\n\nΣάλτσα λεμονιού: Σοτάρουμε αλεύρι σε λιωμένη φυτική μαργαρίνη για 1-2 λεπτά, προσθέτουμε τον ζωμό από το ταψί μαζί με νερό και ρόφημα αμυγδάλου και σιγοβράζουμε ανακατεύοντας μέχρι να δέσει. Αποσύρουμε και προσθέτουμε ξύσμα και χυμό λεμονιού, άνηθο, μαϊντανό, αλάτι και πιπέρι.\n\nΣερβίρισμα: Περιχύνουμε τα κολοκυθάκια με τη σάλτσα λεμονιού και σερβίρουμε με φρέσκο άνηθο, φέτες λεμονιού και ψωμί.'},
  ...
  {id:'bb_egg_whites_oats_veggies',name:'Ασπράδια Αυγών Οβελίσκοι & Λαχανικά',foods:[
    {n:'Ασπράδια αυγών',g:300},{n:'Βρώμη (ωμή)',g:160},{n:'Τομάτες',g:100},{n:'Ελαιόλαδο',g:5}
