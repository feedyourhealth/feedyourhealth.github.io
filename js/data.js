...
[{name:'Πρωινό',foods:[{n:'Γκρανόλα χωρίς ζάχαρη',g:60},{n:'Γάλα πλήρες',g:250},{n:'Φράουλες',g:140},{n:'Μέλι άβραστο',g:15}]},{name:'Σνακ πρωί',foods:[{n:'Κοτόπουλο στήθος (ψητό)',g:80},{n:'Ρυζογκοφρέτες',g:35},{n:'Τομάτες',g:80}]},{name:'Μεσημεριανό',foods:[{n:'Σολομός (ψητός)',g:200},{n:'Κινόα (βρ.)',g:200},{n:'Σπαράγγια',g:140},{n:'Ελαιόλαδο',g:12}]},{name:'Σνακ απόγευμα',foods:[{n:'Γιαούρτι 2%',g:200},{n:'Μπανάνα',g:120},{n:'Αμύγδαλα',g:20}]},{name:'Βραδινό',foods:[{n:'Φακές (μαγειρεμένες)',g:240},{n:'Κοτόπουλο στήθος (ψητό)',g:150},{n:'Τυρί φέτα',g:25},{n:'Ελαιόλαδο',g:10}]}],
