...
function buildTrackerHtml(c){
  ...
  var wHtml='<div class="tracker-section">'
    ...
    +(c.phone?'<button class="btn" style="padding:4px 11px;font-size:11px;background:#25D366;color:#fff;border:none" title="Άνοιγμα PDF για αποθήκευση + WhatsApp με έτοιμο μήνυμα προς τον πελάτη" onclick="sendLipometriaReport(\'wa\')">📱 Αποστολή εντύπου</button>':'<button class="btn" disabled style="padding:4px 11px;font-size:11px;background:#ddd;color:var(--text-muted);border:none;cursor:not-allowed" title="Λείπει τηλέφωνο από την καρτέλα του πελάτη — συμπλήρωσέ το στην καρτέλα «Στοιχεία»">📱 Αποστολή εντύπου</button>')
    +(c.email?'<button class="btn" style="padding:4px 11px;font-size:11px;background:#025857;color:#fff;border:none" title="Άνοιγμα PDF για αποθήκευση + Email με έτοιμο μήνυμα προς τον πελάτη" onclick="sendLipometriaReport(\'mail\')">📧 Αποστολή εντύπου</button>':'<button class="btn" disabled style="padding:4px 11px;font-size:11px;background:#ddd;color:var(--text-muted);border:none;cursor:not-allowed" title="Λείπει email από την καρτέλα του πελάτη — συμπλήρωσέ το στην καρτέλα «Στοιχεία»">📧 Αποστολή εντύπου</button>')
    ...
    +(c.weightLog&&c.weightLog.length?(c.phone?'<button class="btn" style="padding:4px 11px;font-size:11px;background:#25D366;color:#fff;border:none" title="Άνοιγμα PDF για αποθήκευση + WhatsApp με έτοιμο μήνυμα προς τον πελάτη" onclick="sendBodyCompReport(\'wa\')">📱 Αποστολή ιστορικού</button>':'<button class="btn" disabled style="padding:4px 11px;font-size:11px;background:#ddd;color:var(--text-muted);border:none;cursor:not-allowed" title="Λείπει τηλέφωνο από την καρτέλα του πελάτη — συμπλήρωσέ το στην καρτέλα «Στοιχεία»">📱 Αποστολή ιστορικού</button>'):'')
    +(c.weightLog&&c.weightLog.length?(c.email?'<button class="btn" style="padding:4px 11px;font-size:11px;background:#025857;color:#fff;border:none" title="Άνοιγμα PDF για αποθήκευση + Email με έτοιμο μήνυμα προς τον πελάτη" onclick="sendBodyCompReport(\'mail\')">📧 Αποστολή ιστορικού</button>':'<button class="btn" disabled style="padding:4px 11px;font-size:11px;background:#ddd;color:var(--text-muted);border:none;cursor:not-allowed" title="Λείπει email από την καρτέλα του πελάτη — συμπλήρωσέ το στην καρτέλα «Στοιχεία»">📧 Αποστολή ιστορικού</button>'):'')
    +'</div>'
    +'</div>'
