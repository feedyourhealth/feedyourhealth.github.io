...
// ✅ 2026-09-11: OstroVit Cream of Rice - Natural (1000g) — σκέτη κρέμα ρυζιού σε σκόνη (μόνο ρυζάλευρο, χωρίς γεύση/ζάχαρη). Per-100g από ετικέτα: 1485kJ/350kcal, 7.4g πρωτ., 78g υδατ. (0.5g σάκχ.), 0.6g λιπ. (0.1g κορ.), 0.01g αλάτι. Μερίδα ετικέτας 40g = 140kcal/3.0p/31c/0.2f (round-trip ελέγχθηκε: ×0.4 ταιριάζει). fi: εκτίμηση ~0.6g (ραφιναρισμένο ρυζάλευρο, δεν αναγράφεται στην ετικέτα — ελαφρώς χαμηλότερο από VAST γιατί δεν περιέχει ρυζόκοκκους). cat 'Δημητριακά' όπως το VAST instant ρυζόγαλο (ίδια οικογένεια dry ρυζοπροϊόντων).
'Cream of Rice (OstroVit)':{k:350,p:7.4,c:78,f:0.6,fi:0.6,cat:'Δημητριακά',en:'Cream of Rice - Natural (OstroVit)',ru:'Рисовая каша - Натуральная (OstroVit)',tr:'Pirinç Kreması - Doğal (OstroVit)'},
...
// ✅ 2026-09-08: Hungry Not (SDOUKOS) "Layered Bars" — protein bar με στρώσεις πραλίνας φουντουκιού & επικάλυψη σοκολάτας γάλακτος, με ζάχαρη + γλυκαντικά (στέβια). Per-100g από ετικέτα λιανικής (alphamega.com.cy): 1616kJ/387kcal, 40g πρωτ., 21g υδατ. (5.1g σάκχ.), 16g λιπ. (7g κορ.), 9.7g ίνες, 0.95g αλάτι. Συσκ. 150g = 3 μπάρες × 50g (20g πρωτ./μπάρα). Περιέχει φουντούκι (→ QUICK_EXCL Ξηροί καρποί) & γάλα. cat 'Συνταγές FYH' όπως οι υπόλοιπες μπάρες (PB Protein Bars / CrudeSnacks).
'Hungry Not Protein Bar Πραλίνα Φουντουκιού':{k:387,p:40,c:21,f:16,fi:9.7,cat:'Συνταγές FYH',en:'Hungry Not Layered Protein Bar Hazelnut Praline & Milk Chocolate',ru:'Hungry Not слоёный протеиновый батончик с фундучным пралине и молочным шоколадом',tr:'Hungry Not Katmanlı Protein Bar Fındık Pralini & Sütlü Çikolata'},
...
// ✅ 2026-09-08: Nick's Peanut & Caramel ice-cream bar (no added sugar, with sweeteners) — per-100g από ετικέτα λιανικής (foodhaus.com, EU): 1429kJ/342kcal, 8.2g πρωτ., 22g υδατ. (6.9g σάκχ.), 28g λιπ. (16g κορ.), 0.47g αλάτι. Fiber δεν αναγράφεται στην ετικέτα → fi:0. Συσκ. 280ml = 4 μπάρες × 47g.
'Nick\'s Παγωτό Μπάρα Φιστίκι & Καραμέλα':{k:342,p:8.2,c:22,f:28,fi:0,cat:'Άλλα',en:'Nick\'s Peanut & Caramel Ice Cream Bar (no added sugar)',ru:'Nick\'s батончик-мороженое с арахисом и карамелью (без сахара)',tr:'Nick\'s Fıstık & Karamel Dondurma Bar (şeker ilavesiz)'},
...
// ✅ 2026-09-10: Alambra Φυσικός Χυμός Παντζάρι, Μήλο, Πορτοκάλι & Καρότο 1 L — 100% φυσικός χυμός από συμπυκνωμένο, παραγωγή Κύπρου (alphamega.com.cy, κωδ. 854583). Per-100ml από ετικέτα: 226kJ/53kcal, 0.3g πρωτ., 12.8g υδατ. (12.5g σάκχ.), 0.1g λιπ. (0g κορ.), 0g αλάτι. Χωρίς ίνες στην ετικέτα (χυμός) → fi:0. cat 'Ροφήματα' όπως η Πορτοκαλάδα φρέσκια. 1 φλ. = 200ml.
'Alambra Χυμός Παντζάρι, Μήλο, Πορτοκάλι & Καρότο':{k:53,p:0.3,c:12.8,f:0.1,fi:0,cat:'Ροφήματα',en:'Alambra Beetroot, Apple, Orange & Carrot Juice',ru:'Alambra сок: свёкла, яблоко, апельсин и морковь',tr:'Alambra Pancar, Elma, Portakal & Havuç Suyu'},
...
// ✅ 2026-09-11: Chicken Katsu Curry (wagamama) — έτοιμο πιάτο εστιατορίου/delivery, 1 order = 605g.
// Τιμές per-100g από την επίσημη ετικέτα θρεπτικής αξίας (η ίδια πηγή έδωσε και τα per-portion 988kcal/
// 43.9p/110c/41.8f/7.9fi για τα 605g — ταιριάζουν με τα per-100g εδώ). containsCats:['Κρέας'] ώστε να
// πιάνεται σωστά από τους ελέγχους νηστείας/vegan αν και το cat είναι 'Άλλα' (σύνθετο πιάτο, όχι ωμό κρέας).
'Chicken Katsu Curry (wagamama)':{k:162,p:7.2,c:18.1,f:6.9,fi:1.3,cat:'Άλλα',containsCats:['Κρέας'],en:'Chicken Katsu Curry (wagamama)',ru:'Курица катсу карри (wagamama)',tr:'Tavuklu Katsu Köri (wagamama)'},
};
var FOOD_PAIRING_DB={
  // ── PROTEINS ────────────────────────────────────────────────────────────────
