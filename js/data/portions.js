...
var FOOD_UNITS={
  ...
  'Χοιρινό σουβλάκι':{g:20,u:'τεμ.'},   // 1 τεμ. ψητό ~20g · τυπική σούβλα ~10 τεμ. (200g)
...
'Μπιφτέκι Κοτόπουλο Πηδηχτούλης Κόκορας':{g:300,u:'τεμ.'},
  ...
  'Alambra Χυμός Παντζάρι, Μήλο, Πορτοκάλι & Καρότο':{g:200,u:'φλ.'},
  'Chicken Katsu Curry (wagamama)':{g:605,u:'μερίδ.'},
...
var COOKED_TO_RAW={
  ...
  'Χοιρινό σουβλάκι':{f:1.38,label:'ωμό'},
...
var PORTIONS={
'Αλεύρι ολικής άλεσης':[{n:'1 Κ.',g:8},{n:'½ φλ.',g:60},{n:'1 φλ.',g:120}],
...
'Φαγόπυρο (βρ.)':[{n:'½ φλ.',g:85},{n:'1 φλ.',g:170}],
...
'Κυπριακή πίτα':[{n:'1/3 τεμ.',g:60},{n:'1/2 τεμ.',g:90},{n:'ολόκληρη',g:180}],
'Ρυζογκοφρέτες':[{n:'1 τεμ.',g:10},{n:'2 τεμ.',g:20},{n:'3 τεμ.',g:30}],
'Ρυζόγαλο στιγμής (VAST)':[{n:'1 scoop',g:18},{n:'2 scoops',g:36},{n:'3 scoops',g:54},{n:'80g (ξηρό)',g:80}],
'Cream of Rice (OstroVit)':[{n:'½ μερίδα',g:20},{n:'1 μερίδα',g:40},{n:'2 μερίδες',g:80}],
...
'Χοιρινό σουβλάκι':[{n:'5 τεμ. (½ σούβλα)',g:100},{n:'8 τεμ.',g:160},{n:'10 τεμ. (1 σούβλα)',g:200},{n:'15 τεμ.',g:300}],
...
'Alambra Χυμός Παντζάρι, Μήλο, Πορτοκάλι & Καρότο':[{n:'½ ποτήρι',g:100},{n:'1 ποτήρι',g:200},{n:'250 ml',g:250}],
...
'Chicken Katsu Curry (wagamama)':[{n:'½ μερίδα',g:303},{n:'1 μερίδα (order)',g:605}]
};
