...
var SNACK_RECIPES=[
  ...
  // ✅ 2026-09-23: FYH Μπανανόψωμο — πραγματική συνταγή FYH. Ολόκληρο κέικ = 3 ώριμες μπανάνες (~360g), 2 αυγά,
  // 113g μέλι, 70g γιαούρτι, 106ml (~97g) ελαιόλαδο, 250g αλεύρι ολικής, 1 κ.γλ. βανίλια, 1 κ.γλ. σόδα, πρέζα αλάτι/κανέλα,
  // ~100g toppings. Μερίδα = 1/12 του κέικ (1 φέτα). Βανίλια/σόδα/αλάτι αμελητέα → εκτός foods (μόνο στις οδηγίες).
  {id:'fyh_banana_bread',name:'Μπανανόψωμο FYH (Ολικής με Μέλι)',foods:[
    {n:'Μπανάνα',g:30},{n:'Αλεύρι ολικής άλεσης',g:21},{n:'Αυγά (ολόκληρα)',g:10},{n:'Μέλι άβραστο',g:9},{n:'Ελαιόλαδο',g:8},{n:'Γιαούρτι 2%',g:6},{n:'Dark Chocolate 70%',g:8},{n:'Κανέλα',g:0.2}
  ],kcal:263,macro:{p:6,f:13,c:33},prepTimeMin:60,tags:['Vegetarian','FYH','Γλυκό','Ενέργεια'],mealTimes:['Πρωινά','Ενδιάμεσα'],
  instructions:'Για 1 κέικ (12 φέτες). Υλικά: 3 ώριμες μπανάνες, 2 αυγά, 113g μέλι, 70g γιαούρτι, 106ml ελαιόλαδο, 250g αλεύρι ολικής άλεσης, 1 κ.γλ. εκχύλισμα βανίλιας, 1 κ.γλ. σόδα μαγειρικής, πρέζα αλάτι, πρέζα κανέλα, ~100g toppings της επιλογής σου (μαύρη σοκολάτα, ξηροί καρποί, χουρμάδες).\n\n1. Προθέρμανε τον φούρνο στους 175°C και στρώσε μια φόρμα κέικ με λαδόχαρτο.\n2. Λιώσε τις μπανάνες με πιρούνι και ανακάτεψε με τα αυγά, το μέλι, το γιαούρτι, το ελαιόλαδο και τη βανίλια.\n3. Σε άλλο μπολ ανακάτεψε το αλεύρι, τη σόδα, το αλάτι και την κανέλα.\n4. Ένωσε τα στεγνά με τα υγρά υλικά ανακατεύοντας απαλά, μόνο μέχρι να ενωθούν. Πρόσθεσε τα toppings.\n5. Ψήσε 45–55 λεπτά, μέχρι μια οδοντογλυφίδα να βγαίνει καθαρή. Άφησέ το να κρυώσει πριν το κόψεις σε 12 φέτες.'},
