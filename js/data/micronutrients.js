...
var MICRONUTRIENTS={
  ...
  'Αλεύρι ολικής άλεσης':{Fe:3.6,Zn:2.6,Mg:137,Ca:34,B1:0.5,B2:0.17,B3:5,B6:0.41,B12:0,Folate:44,Omega3:0.04,Omega6:1.1,Iodine:0,Choline:31,DHA:0},
  ...
  // Εκτίμηση — η ετικέτα έχει μόνο μακροθρεπτικά + αλάτι (καμία ενίσχυση βιταμινών)· σκέτο ρυζάλευρο, ελαφρώς χαμηλότερο από VAST (καμία προσθήκη ρυζόκοκκων)
  'Cream of Rice (OstroVit)':{Fe:0.4,Zn:0.6,Mg:18,Ca:6,B1:0.04,B2:0.02,B3:1.4,B6:0.08,B12:0,Folate:6,Omega3:0.02,Omega6:0.2,Iodine:0,Choline:4,DHA:0},
  ...
  // Εκτίμηση — η ετικέτα λιανικής έχει μόνο μακροθρεπτικά· μοντέλο σε πραλίνα φουντουκιού + σοκολάτα γάλακτος + πρωτεΐνη γάλακτος + ίνες (πολυδεξτρόζη/ρίζα κιχωρίου)
  'Hungry Not Protein Bar Πραλίνα Φουντουκιού':{Fe:2.5,Zn:2.5,Mg:85,Ca:180,B1:0.15,B2:0.4,B3:1.5,B6:0.15,B12:0.8,Folate:35,Omega3:0.05,Omega6:2.5,Iodine:10,Choline:40,DHA:0},
