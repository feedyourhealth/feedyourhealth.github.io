(function(){
  var Cloud = {
    ...
    _buildSnapshot:function(c){
      ...
      var EN_SUPP_TIMING={'2-3 ώρες πριν προπόνηση':'2-3h before training',"60' πριν προπόνηση/αγώνα":"60' before training/race",'Κατά την προπόνηση':'During training','Αμέσως μετά προπόνηση':'Right after training','Βραδινό':'Dinner','Με το πρωινό':'With breakfast','Μεσημεριανό':'Lunch',"Πριν προπόνηση (30')":"Before training (30')",'Πριν το πρωινό':'Before breakfast','Πριν τον ύπνο':'Before bed','πρωί με φαγητό':'Morning, with food','με φαγητό':'With food','βράδυ':'Evening','οποιαδήποτε ώρα':'Any time','με γεύμα':'With a meal','μετά την άσκηση':'After training','πρωί χωρίς καφές':'Morning, no coffee'};
      var RU_SUPP_TIMING={'2-3 ώρες πριν προπόνηση':'За 2-3 ч до тренировки',"60' πριν προπόνηση/αγώνα":'За 60 мин до тренировки/старта','Κατά την προπόνηση':'Во время тренировки','Αμέσως μετά προπόνηση':'Сразу после тренировки','Βραδινό':'Ужин','Με το πρωινό':'С завтраком','Μεσημεριανό':'Обед',"Πριν προπόνηση (30')":'За 30 мин до тренировки','Πριν το πρωινό':'Перед завтраком','Πριν τον ύπνο':'Перед сном','πρωί με φαγητό':'Утром, с едой','με φαγητό':'С едой','βράδυ':'Вечером','οποιαδήποτε ώρα':'В любое время','με γεύμα':'Во время еды','μετά την άσκηση':'После тренировки','πρωί χωρίς καφές':'Утром, без кофе'};
      var TR_SUPP_TIMING={'2-3 ώρες πριν προπόνηση':'Antrenmandan 2-3 saat önce',"60' πριν προπόνηση/αγώνα":'Antrenman/yarıştan 60dk önce','Κατά την προπόνηση':'Antrenman sırasında','Αμέσως μετά προπόνηση':'Antrenmandan hemen sonra','Βραδινό':'Akşam yemeği','Με το πρωινό':'Kahvaltıyla birlikte','Μεσημεριανό':'Öğle yemeği',"Πριν προπόνηση (30')":'Antrenmandan 30dk önce','Πριν το πρωινό':'Kahvaltıdan önce','Πριν τον ύπνο':'Yatmadan önce','πρωί με φαγητό':'Sabah, yemekle birlikte','με φαγητό':'Yemekle birlikte','βράδυ':'Akşam','οποιαδήποτε ώρα':'Günün her saati','με γεύμα':'Bir öğünle birlikte','μετά την άσκηση':'Antrenmandan sonra','πρωί χωρίς καφές':'Sabah, kahvesiz'};
